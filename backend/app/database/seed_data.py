...
def seed_database(db: Session):
    """
    Populate database with deterministic realistic logistics demo data if empty.
    """
    ...
    # 2. Customers
    customers_data = [
        {"id": "C01", "name": "Apex Electronics Ltd", "address": "Block B, Inner Circle, Connaught Place, New Delhi", "lat": 28.6315, "lng": 77.2167, "priority": 5, "zone": "Z_NORTH"},
        ...
        {"id": "C22", "name": "Aerocity Hospitality Hub", "address": "Hospitality District, Aerocity, New Delhi", "lat": 28.5550, "lng": 77.1210, "priority": 5, "zone": "Z_WEST"},
        {"id": "C23", "name": "Faridabad Industrial Sector 31", "address": "Mathura Road, Sector 31, Faridabad", "lat": 28.4680, "lng": 77.3090, "priority": 4, "zone": "Z_SOUTH"},
    ...
    packages_data = [
        ...
        {"id": "PKG-111", "tn": "RN-98224", "cid": "C11", "w": 25.0, "v": 1400.0, "p": 3, "st": "LOADED", "vid": "V03"},
        {"id": "PKG-112", "tn": "RN-98225", "cid": "C12", "w": 14.2, "v": 2800.0, "p": 4, "st": "LOADED", "vid": "V03"},
        ...
        {"id": "PKG-118", "tn": "RN-98231", "cid": "C18", "w": 16.0, "v": 5200.0, "p": 5, "st": "LOADED", "vid": "V02"},
    ...
    vehicles_data = [
        {
            ...
            "lat": 28.6100,
            "lng": 77.1800,
            "route": json.dumps(["W1", "N01", "N05", "N10", "C01"])
        },
        {
            "id": "V02",
            "num": "DL-03-EV-8812",
            ...
            "lat": 28.5400,
            "lng": 77.2400,
            "route": json.dumps(["W1", "N02", "N08", "C02", "C05", "C18"])
        },
        {
            "id": "V03",
            "num": "HR-26-CC-1920",
            ...
            "lat": 28.6800,
            "lng": 77.1300,
            "route": json.dumps(["W1", "N03", "N11", "C11", "C12"])
        },
        {
            "id": "V04",
            "num": "UP-14-BT-9041",
    ...
    # 5. Graph Network Nodes (Road Intersections & Hubs)
    nodes_data = [
    ...
    # 6. Graph Network Edges (Roads & Capacities)
    edges_data = [
        ...
        {"id": "E14", "src": "N08", "tgt": "HUB_SOUTH", "name": "Mathura Road Bottleneck", "dist": 3.8, "cap": 800.0}  # Intentionally low capacity bottleneck!
    ]
    ...
    # 7. Zones
    zones_data = [
        {"id": "Z_NORTH", "name": "North Logistics Zone", "color": "#3B82F6", "lat": 28.6800, "lng": 77.1600, "area": 85.4, "count": 6},
        {"id": "Z_SOUTH", "name": "South Metropolitan Zone", "color": "#10B981", "lat": 28.5400, "lng": 77.2300, "area": 112.0, "count": 10},
        {"id": "Z_WEST", "name": "West Cyber/Airport Zone", "color": "#F59E0B", "lat": 28.5200, "lng": 77.0800, "area": 94.2, "count": 5},
        {"id": "Z_EAST", "name": "East Tech Trans-Yamuna Zone", "color": "#8B5CF6", "lat": 28.6100, "lng": 77.3400, "area": 78.6, "count": 4}
    ]
